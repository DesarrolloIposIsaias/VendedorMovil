package com.example.admin.iposapp.utility.util;

import com.example.admin.iposapp.utility.core.DbfField;
import com.example.admin.iposapp.utility.core.DbfFieldTypeEnum;
import com.example.admin.iposapp.utility.core.DbfFileTypeEnum;
...
//	}
    ...
    public static DbfField createDbfField(byte[] fieldBytes) {
        ...
        // 2. Set type
        field.setType(DbfFieldTypeEnum.Character.fromChar((char) fieldBytes[11]));
        // 3. Set length
        {
